...
const Trips = () => {
  ...
  return (
    <div className="container mx-auto flex flex-col items-center lg:items-start p-5 lg:pt-10">
      <h1 className="text-customPurple-dark font-semibold text-xl lg:w-full lg:text-left lg:text-[2.5rem]">Viagens Encontradas</h1>
      <h2 className="text-customGray font-medium mb-5 lg:mt-6 lg:w-full lg:text-left">
