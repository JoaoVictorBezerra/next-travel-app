...
const TripConfirmation = ({ params }: { params: { tripId: string } }) => {
  ...
  return (
    <div className="container mx-auto p-5 lg:max-w-[600px]">
      <h1 className="font-semibold text-xl text-customPurple-dark">Sua viagem</h1>
      ...
      <div className="flex flex-col p-5 mt-5 border-customGray-light border-solid border shadow-lg rounded-lg">
        ...
        <h3 className="font-semibold text-lg text-customPurple-dark mt-3">Informações sobre o preço</h3>

        <div className="flex justify-between mt-1">
          <p className="text-customPurple-dark">Total:</p>
